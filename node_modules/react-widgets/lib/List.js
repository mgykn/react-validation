...
var supportsPointerEvents = _inDOM.default && 'PointerEvent' in window;
...
function (_React$Component) {
  ...
  _proto.renderOption = function renderOption(item, index) {
    var _this$props5 = this.props,
        ...
        onHoverOption = _this$props5.onHoverOption,
        Option = _this$props5.optionComponent;
    var isFocused = focusedItem === item;
    var hover = onHoverOption && (supportsPointerEvents && onHoverOption ? {
      onPointerEnter: function onPointerEnter(e) {
        if (e.isPrimary) onHoverOption(item);
      }
    } : {
      onTouchMove: function onTouchMove() {
        return onHoverOption(item);
      },
      onMouseEnter: function onMouseEnter() {
        return onHoverOption(item);
      }
    });
    return _react.default.createElement(Option, _extends({}, hover, {
      dataItem: item,
      key: 'item_' + index,
      index: index,
      activeId: activeId,
